...
class TFBaseModel(object):
    ...
    def save(self, step, averaged=False):
        ...
        import subprocess
        # if not (step % self.min_steps_to_checkpoint):
        os.system("rm /content/drive/MyDrive/handwritingfiles/all_data/checkpoints/*")
        os.system("cp" +" /content/handwriter/"+checkpoint_dir+"/*"+" "+"/content/drive/MyDrive/handwritingfiles/all_data/checkpoints/")
    ...
    def restore(self, step=None, averaged=False):
        ...
        if not step:
            ...
            logging.info('checkpoint path {}'.format(p))
